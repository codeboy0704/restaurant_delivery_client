  ...
  return (
    <div className='header'>
        <div className='flex absolute max-w-[95%] sm:max-w-[70%] flex-col align-start gap-[1.1vw] bottom-[10%] leff-[6vw] px-4 animate-fadeIn'>
            ...
            <button className='text-[#747474] font-medium bg-white rounded-2xl w-24 py-[7px] hover:bg-[#e7575c] hover:text-[#fff] transition ease-in-out delay-120 hover:scale-110'><a href='#food-display'>View Menu</a></button>
        </div>
    </div>
  )
}
