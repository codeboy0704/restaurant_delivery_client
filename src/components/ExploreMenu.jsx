    ...
    return (
        <div className='flex flex-col gap-2' id='explore-menu'>
            ...
            <div className='mx-2 '>
                ...
                {menu_list.map((el, i) => {
                    return (
                            <div className='flex flex-col justify-center align-center' onClick={() => setCategory(prev => prev === el.menu_name ? "All" : el.menu_name)} key={i}>
                                ...
                                <p className='m-t-[10px] mx-5 my-1 text-[#747474] pointer text-[1.4vw, 16px] '>{el.menu_name}</p>
                            </div>
                    )
                })}
                </Slider>
